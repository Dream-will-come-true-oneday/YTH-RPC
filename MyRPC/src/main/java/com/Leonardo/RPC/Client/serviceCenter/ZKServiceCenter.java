package com.Leonardo.RPC.Client.serviceCenter;

import com.Leonardo.RPC.Client.cache.ServiceCache;
import com.Leonardo.RPC.Client.serviceCenter.ZKWatcher.watchZK;
...
public class ZKServiceCenter implements ServiceCenter{
    ...
    public ZKServiceCenter() throws InterruptedException{
        ...
        // 加入zookeeper监听
        watch = new watchZK(client, cache);
        watch.watchToUpdate(ROOT_PATH);
    }
    @Override
